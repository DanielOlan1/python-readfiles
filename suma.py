...
class Aplicacion(tk.Tk):
    ...
    def mostrar_datos(self, event):
        ...
        self.formulario_texto_faltante.insert(tk.END, str(datos_fila[12]))

        tiempo_viaje = self.calcular_tiempo_viaje(datos_fila[6], datos_fila[7])
        self.formulario_texto_tiempoViaje.config(text=str(tiempo_viaje))
    ...
    def abrir_archivo_excel(self):
        ...
        if archivo:
            ...
            columnas_requeridas = ["operador", "unidad", "letraPR", "origenMunicipio", "destinoMunicipio", "cliente",
                                   "fechaCarga", "fechaDescarga", "producto", "cartaPorte", "litrosCargados",
                                   "litrosDescargados", "faltante"]
    ...
    def crear_formulario(self):
        ...
        formulario_label_tiempoViaje = tk.Label(self.formulario_frame, text="Tiempo de Viaje:", fg="green", font=("Arial", 12))
